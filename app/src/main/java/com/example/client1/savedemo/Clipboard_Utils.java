...
public class Clipboard_Utils {
    ...
    public static void copyToClipboard(Context mContext, String data)
    {
    ...
    private static void copyToClipboardForHoney(Context mContext, String data)
    {
    ...
    private static void copyToClipboardHoneyLess(Context mContext, String data)
    {
